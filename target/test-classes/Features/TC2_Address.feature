Feature: Address Module API automation
  ...
  Scenario Outline: Get User logtoken from login endpoint and add user address
  ...
  Scenario Outline: Get User logtoken from login endpoint, add user address and update user address
    Given User add header
    And User add basic authentication for login
    When User send "POST" request for login endpoint
    Then User verify the status code is 200
  ...
  Scenario Outline: Get User logtoken from login endpoint, add user address, update user address and delete user  address
    Given User add header
    And User add basic authentication for login
    When User send "POST" request for login endpoint
    Then User verify the status code is 200
  ...
  Scenario Outline: Get User logtoken from login endpoint, add user address, update user address, delete user  address and get user address
    Given User add header
    And User add basic authentication for login
    When User send "POST" request for login endpoint
    Then User verify the status code is 200
